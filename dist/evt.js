...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FnQueue", function() { return FnQueue; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_define_property__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign__ = __webpack_require__(58);
...
var FnQueue = function () {
	...
	_createClass(FnQueue, [{
		...
		value: function cycle() {
			this.queue = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign___default()([], this.stack);
			return this;
		}
	}, {
		key: 'next',
	...
	_createClass(Signal, [{
		...
		value: function emit() {
			...
			if (this.stack[id]) {
				...
				(_stack$id$queue2 = this.stack[id].queue).fire.apply(_stack$id$queue2, arguments);
			} else {
				// 2：事件不存在则放入缓存列表
				this.cache[id] = {
					params: arguments
